...
//		theMesh->coordIndex = malloc(sizeof(int) * coordCount);
		theMesh->coordIndex = (GLint*)calloc(coordCount, sizeof(int));
	if (hasNormalIndices)
//		theMesh->normalsIndex = malloc(sizeof(int) * coordCount);
		theMesh->normalsIndex = (GLint*)calloc(coordCount, sizeof(int));
	if (hasTexCoordIndices)
//		theMesh->textureIndex = malloc(sizeof(int) * coordCount);
		theMesh->textureIndex = (GLint*)calloc(coordCount, sizeof(int));

	theMesh->coordStarts = (GLint*)malloc(sizeof(int));
...
//	fp = fopen(filename, "rb");
	...
	{
		theMesh->coordStarts = (GLint*)realloc(theMesh->coordStarts, (theMesh->groupCount+1)*sizeof(int));
...
//	newCoords = malloc(sizeof(int) * triangleCount * 3);
	newCoords = (GLint*)calloc(triangleCount * 3, sizeof(int));
	if (theMesh->normalsIndex != NULL)
//		newNormalsIndex = malloc(sizeof(int) * triangleCount * 3);
		newNormalsIndex = (GLint*)calloc(triangleCount * 3, sizeof(int));
	if (theMesh->textureIndex != NULL)
//		newTextureIndex = malloc(sizeof(int) * triangleCount * 3);
		newTextureIndex = (GLint*)calloc(triangleCount * 3, sizeof(int));
...
//		mesh->normalsIndex = malloc(sizeof(GLuint) * mesh->coordCount);
		mesh->normalsIndex = (GLint*)calloc(mesh->coordCount, sizeof(GLuint));
...
Mesh **SplitToMeshes(Mesh *m)
{
	...
	for (i = 0; i < m->groupCount+1; i++)
	{
		...
		mm[i]->coordIndex = (GLint*)malloc(m->coordCount * sizeof(int));
		mm[i]->normalsIndex = (GLint*)malloc(m->coordCount * sizeof(int));
		mm[i]->textureIndex = (GLint*)malloc(m->coordCount * sizeof(int));
