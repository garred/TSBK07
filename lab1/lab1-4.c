...
GLfloat colors[] =
{
	1.f,0.f,0.f,1.f,		//lower-left
	0.f,1.f,0.f,1.f,		//top
	0.f,0.f,1.f,1.f 		//lower-right
};
...
void init(void)
{
	...
	// VBO for color vertex data
	glGenBuffers(1, &vertexColorBufferObjID);
	glBindBuffer(GL_ARRAY_BUFFER, vertexColorBufferObjID);
