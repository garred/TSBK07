...
void load_terrain() {
  ...
  LoadTGATextureData("media/Terrain2/heightmap.tga", &heightmap_texture);
  GenerateTerrain(&terrain, &heightmap_texture);

	for (int i=0; i<8; i++) {
    terrain.static_object.t[i] = (i==0) ? white_texture : 0;
    terrain.static_object.a[i] = (i==0) ? white_texture : 0;
		terrain.static_object.tiles[i] = 30.0;
  }
  LoadTGATextureSimple("media/Terrain2/water.tga", &(terrain.static_object.t[0]));
	LoadTGATextureSimple("media/Terrain2/level_0.tga", &(terrain.static_object.a[0]));
	LoadTGATextureSimple("media/Terrain2/sand.tga", &(terrain.static_object.t[1]));
	LoadTGATextureSimple("media/Terrain2/level_1.tga", &(terrain.static_object.a[1]));
	LoadTGATextureSimple("media/Terrain2/grass.tga", &(terrain.static_object.t[2]));
	LoadTGATextureSimple("media/Terrain2/level_2.tga", &(terrain.static_object.a[2]));
	LoadTGATextureSimple("media/Terrain2/rock-grass.tga", &(terrain.static_object.t[3]));
	LoadTGATextureSimple("media/Terrain2/level_3.tga", &(terrain.static_object.a[3]));
	LoadTGATextureSimple("media/Terrain2/rock.tga", &(terrain.static_object.t[4]));
	LoadTGATextureSimple("media/Terrain2/level_4.tga", &(terrain.static_object.a[4]));
